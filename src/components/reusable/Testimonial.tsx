  ...
  return (
    <section className="py-12 dark:bg-main-bg">
      <div className=" relative py-12 flex h-w-full flex-col items-center justify-center overflow-hidden rounded-lg bg-transparent border-0 text-center">
        ...
        <p className="lg:text-xl md:text-xl pt-5">
          What Our Clients Say <br></br>
          We help you create awesome websites, landing pages, and apps for your
          business. <br></br> Don’t just take our word for it—check out what our happy
          clients have to say!
        </p>
      </div>
