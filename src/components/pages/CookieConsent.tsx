...
const CookieConsent: React.FC = () => {
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 bg-[#121212]/95 backdrop-blur-md border-t border-[#1E293B]/50 text-white p-4 shadow-2xl z-50 transition-all duration-300 ${
      isVisible ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'
    }`}>
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex-1">
          <p className="text-sm md:text-base text-[#F1F5F9] leading-relaxed">
