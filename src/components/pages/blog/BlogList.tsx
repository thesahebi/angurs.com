    ...
    <>
      ...
      {isSeeMore && (
        <div className="text-center mt-12">
          <Link
            to="/blogs"
            className="inline-flex items-center px-8 py-3 text-lg font-medium text-white border border-white/20 rounded-full transition-colors duration-200 hover:bg-[#e95420]"
