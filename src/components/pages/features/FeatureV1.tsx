          ...
          <div className="bg-gradient-to-r from-[#1f2937] to-[#374151] rounded-3xl p-12 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-[#1f2937] bg-white hover:bg-gray-100 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl"
              >
              ...
              <a
                href="/contact"
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white border-2 border-white hover:bg-white hover:text-[#1f2937] rounded-xl transition-all duration-200"
              >
                Learn More
              </a>
            </div>
