    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">Continuously pushing boundaries and exploring new technologies to deliver cutting-edge solutions.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Working together as one team, sharing knowledge, and supporting each other's growth.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Committed to delivering the highest quality solutions and exceeding client expectations.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Embracing continuous learning and staying at the forefront of technology trends.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Cloud Architects</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">DevOps Engineers</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Security Specialists</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Network Engineers</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Data Protection Experts</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Solution Architects</h3>
              <p className="text-gray-600 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">We invest in our team's growth through training, certifications, and conference attendance.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Regular tech talks, documentation, and peer mentoring to share expertise across the team.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">We take pride in delivering high-quality solutions and maintaining the highest standards.</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Innovation Time</h3>
                  <p className="text-gray-600">Dedicated time for exploring new technologies and working on passion projects.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Flexible working arrangements and support for maintaining a healthy work-life balance.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Contributing to open-source projects and engaging with the broader technology community.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <a
            href="/about/careers"
            className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-green-600 bg-white rounded-full hover:bg-gray-50 transition-colors shadow-lg"
          >
            View Open Positions
          </a>
        </div>
