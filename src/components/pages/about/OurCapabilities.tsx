  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      <PageHero
        ...
        description="Comprehensive technology expertise across cloud, security, automation, and infrastructure solutions to drive your digital transformation."
      ...
      {/* Core Services */}
      <section id="services" className="py-16 md:py-24 bg-[#1A1A1A]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12 md:mb-20">
            <h2 className="text-2xl font-bold text-[#e7e7e7] mb-4">Core Services</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {/* Cloud & Platform */}
            <div className="bg-[#1A1A1A] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-[#e7e7e7] mb-4">Cloud & Platform</h3>
            ...
            <div className="bg-[#1A1A1A] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-[#e7e7e7] mb-4">Security & Compliance</h3>
              <p className="text-[#e7e7e7] leading-relaxed mb-6">
            ...
            <div className="bg-[#1A1A1A] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-[#e7e7e7] mb-4">Automation & DevOps</h3>
              <p className="text-[#e7e7e7] leading-relaxed mb-6">
