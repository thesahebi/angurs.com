        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="bg-[#121212] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Cloud & Platform</h3>
            ...
            <div className="bg-[#121212] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Security & Compliance</h3>
              <p className="text-[#E2E8F0] leading-relaxed mb-6">
            ...
            <div className="bg-[#121212] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Automation & DevOps</h3>
              <p className="text-[#E2E8F0] leading-relaxed mb-6">
