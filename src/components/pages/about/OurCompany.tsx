        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-[#121212] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Our Mission</h3>
            ...
            <div className="bg-[#121212] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Our Vision</h3>
              <p className="text-[#E2E8F0] leading-relaxed">
            ...
            <div className="bg-[#121212] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Our Values</h3>
              <p className="text-[#E2E8F0] leading-relaxed">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-2">Years Experience</h3>
              <p className="text-[#E2E8F0]">Proven track record in enterprise infrastructure</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-2">Projects Delivered</h3>
              <p className="text-[#E2E8F0]">Successful implementations across industries</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-2">Support</h3>
              <p className="text-[#E2E8F0]">Round-the-clock assistance and monitoring</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-2">Client Satisfaction</h3>
              <p className="text-[#E2E8F0]">Dedicated to exceeding expectations</p>
            </div>
          </div>
        </div>
      </section>
