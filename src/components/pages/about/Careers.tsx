...
const Careers: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-[#e7e7e7] max-w-2xl mx-auto mb-6 sm:mb-8">
              Join a team that values innovation, growth, and making a real impact in the world of infrastructure and cloud solutions. 
              Work on cutting-edge projects with talented colleagues.
            </p>
      ...
      {/* Open Positions */}
      <section id="open-positions" className="py-16 md:py-24 bg-[#0A0A0A]">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* UI/UX Designer Job */}
              <div 
                className="bg-[#1A1A1A] rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-[#3b82f6]/20 overflow-hidden cursor-pointer group"
                onClick={() => handleJobClick('/about/careers/ui-ux-designer')}
              >
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <div className="w-[40px] h-[40px] bg-gradient-to-br from-[#3B82F6] to-[#d1451a] rounded-xl flex items-center justify-center mr-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-[#e7e7e7] mb-2 group-hover:text-[#3B82F6] transition-colors">UI/UX Designer</h3>
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <div className="w-[40px] h-[40px] bg-gradient-to-br from-[#3b82f6] to-[#2563eb] rounded-xl flex items-center justify-center mr-4">
                    <svg className="w-6 h-6 text-[#e7e7e7]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                    </svg>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-[#e7e7e7] mb-2 group-hover:text-[#3b82f6] transition-colors">AI Agent Developer</h3>
                    <div className="flex flex-wrap gap-1">
                      <span className="px-2 py-1 bg-[#3b82f6]/10 text-[#3b82f6] rounded-full text-xs font-medium">
                        Full-time
                      </span>
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <div className="w-[40px] h-[40px] bg-gradient-to-br from-[#10b981] to-[#059669] rounded-xl flex items-center justify-center mr-4">
                    <svg className="w-6 h-6 text-[#e7e7e7]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                    </svg>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-[#e7e7e7] mb-2 group-hover:text-[#10b981] transition-colors">Backend Developer</h3>
                    <div className="flex flex-wrap gap-1">
                      <span className="px-2 py-1 bg-[#10b981]/10 text-[#10b981] rounded-full text-xs font-medium">
                        Full-time
                      </span>
      ...
      {/* Why Work With Us */}
      <section id="benefits" className="py-16 md:py-24 bg-[#0A0A0A]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12 md:mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#e7e7e7] mb-3">Cutting-Edge Projects</h3>
              <p className="text-[#e7e7e7]">Work on innovative solutions using the latest technologies and best practices.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#e7e7e7] mb-3">Continuous Learning</h3>
              <p className="text-[#e7e7e7]">Access to training, certifications, and conferences to advance your skills.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#e7e7e7] mb-3">Collaborative Culture</h3>
              <p className="text-[#e7e7e7]">Work with talented, supportive colleagues who share your passion for technology.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#e7e7e7] mb-3">Impact & Growth</h3>
              <p className="text-[#e7e7e7]">Make a real difference while advancing your career with clear growth paths.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#e7e7e7] mb-3">Flexible Work</h3>
              <p className="text-[#e7e7e7]">Remote-friendly environment with flexible hours and work-life balance.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#e7e7e7] mb-3">Competitive Benefits</h3>
              <p className="text-[#e7e7e7]">Comprehensive benefits package including health, dental, and retirement plans.</p>
            </div>
          </div>
        </div>
      </section>
