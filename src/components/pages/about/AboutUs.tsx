      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-[#0A0A0A]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 max-w-7xl mx-auto">
            <div className="text-center">
              <div className="w-[40px] h-[40px] bg-[#3B82F6] rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <span className="text-lg sm:text-xl md:text-2xl font-bold text-[#e7e7e7]">10+</span>
              </div>
              <h3 className="text-base sm:text-lg md:text-xl font-semibold text-[#e7e7e7] mb-2">Years Experience</h3>
              <p className="text-xs sm:text-sm md:text-base text-[#e7e7e7]">Proven track record in enterprise infrastructure</p>
            </div>

            <div className="text-center">
              <div className="w-[40px] h-[40px] bg-[#3B82F6] rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <span className="text-lg sm:text-xl md:text-2xl font-bold text-[#e7e7e7]">500+</span>
              </div>
              <h3 className="text-base sm:text-lg md:text-xl font-semibold text-[#e7e7e7] mb-2">Projects Delivered</h3>
              <p className="text-xs sm:text-sm md:text-base text-[#e7e7e7]">Successful implementations across industries</p>
            </div>

            <div className="text-center">
              <div className="w-[40px] h-[40px] bg-[#3B82F6] rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <span className="text-lg sm:text-xl md:text-2xl font-bold text-[#e7e7e7]">24/7</span>
              </div>
              <h3 className="text-base sm:text-lg md:text-xl font-semibold text-[#e7e7e7] mb-2">Support</h3>
              <p className="text-xs sm:text-sm md:text-base text-[#e7e7e7]">Round-the-clock assistance and monitoring</p>
            </div>

            <div className="text-center">
              <div className="w-[40px] h-[40px] bg-[#3B82F6] rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <span className="text-lg sm:text-xl md:text-2xl font-bold text-[#e7e7e7]">100%</span>
              </div>
              <h3 className="text-base sm:text-lg md:text-xl font-semibold text-[#e7e7e7] mb-2">Client Satisfaction</h3>
              <p className="text-xs sm:text-sm md:text-base text-[#e7e7e7]">Dedicated to exceeding expectations</p>
            </div>
          </div>
        </div>
      </section>
