      ...
      <section className="pt-[210px] pb-32 md:pb-40 lg:pb-48 bg-[#0A0A0A]">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold lg:font-semibold mb-6 lg:leading-[90px]" style={{ color: '#3b82f6', wordWrap: 'break-word' }}>
              Transform Your IT Infrastructure with Expert Virtualization Solutions
              </h1>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-xl font-semibold mb-6 text-[#e7e7e7]" style={{ wordWrap: 'break-word' }}>
            ...
            <div className="flex justify-center items-center mb-6">
                ...
                style={{ backgroundColor: '#3b82f6', wordWrap: 'break-word' }}
              >
            ...
            <div className="text-xs sm:text-sm text-[#e7e7e7] opacity-60" style={{ wordWrap: 'break-word' }}>
      ...
      <section id="services" className="py-24 md:py-40 lg:py-48 bg-[#0A0A0A]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 md:mb-20">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6" style={{ color: '#3B82F6', wordWrap: 'break-word' }}>
              Comprehensive Services Built for Your Success
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-[#e7e7e7] opacity-80 max-w-4xl mx-auto mb-12" style={{ wordWrap: 'break-word' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            ...
            <div className="group relative bg-[#1E293B] rounded-2xl p-6 sm:p-8 border border-white/10 hover:border-[#3b82f6]/30 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-[#3b82f6]/10">
              <div className="text-center">
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-4 text-[#e7e7e7]" style={{ wordWrap: 'break-word' }}>
                  Virtual Machine (VM) Building & Deployment
                </h3>
                <p className="text-sm sm:text-base text-[#e7e7e7] opacity-80 mb-4" style={{ wordWrap: 'break-word' }}>
                  Custom VM creation optimized for your workloads—from Windows/Linux servers to high-performance applications.
                </p>
                <div className="text-xs sm:text-sm text-[#3b82f6] font-semibold mb-4" style={{ wordWrap: 'break-word' }}>
