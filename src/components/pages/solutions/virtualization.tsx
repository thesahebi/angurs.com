        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-12 max-w-7xl mx-auto">
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-[#1f2937] mb-4">Accurate & Reliable</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-[#1f2937] mb-4">Optimize Onboarding</h3>
              <p className="text-lg text-[#6b7280] leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-[#1f2937] mb-4">Built-In Testing</h3>
              <p className="text-lg text-[#6b7280] leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              <div className="bg-[#f8fafc] rounded-lg p-6">
                <div className="flex items-center mb-4">
                  ...
                  <span className="text-sm text-gray-500 ml-4">vm-dashboard.html</span>
                </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                <div className="bg-[#f8fafc] rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <div className="w-3 h-3 bg-yellow-500 rounded-full mr-2"></div>
                    <div className="w-3 h-3 bg-green-500 rounded-full mr-2"></div>
                    <span className="text-sm text-gray-500 ml-4">vm-manager.py</span>
                  </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                <div className="bg-[#f8fafc] rounded-lg p-6">
                  <div className="text-center">
                    ...
                    <h3 className="font-bold text-[#1f2937] mb-2">Cost Optimization</h3>
                    <p className="text-sm text-[#6b7280]">60% reduction in infrastructure costs</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#6b7280] mb-8 max-w-3xl mx-auto">
            ...
            <p className="text-base text-[#6b7280] mb-12 max-w-4xl mx-auto">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="bg-[#f8fafc] rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <div className="w-3 h-3 bg-yellow-500 rounded-full mr-2"></div>
                    <div className="w-3 h-3 bg-green-500 rounded-full mr-2"></div>
                    <span className="text-sm text-gray-500 ml-4">vm-portal.html</span>
                  </div>
                  <div className="space-y-3">
                    <div className="h-4 bg-[#3b82f6] rounded w-3/4"></div>
                    <div className="h-4 bg-gray-200 rounded w-1/2"></div>
          ...
          <div className="text-center">
            ...
            {/* Certificates */}
            <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-[#6b7280]">
