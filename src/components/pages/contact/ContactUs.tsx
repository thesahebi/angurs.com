...
const ContactUs: React.FC = () => {
  ...
  return (
    <main className="min-h-screen bg-[#0A0A0A]">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 md:mb-12">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[#e7e7e7] mb-3">
                Support &{' '}
                <span className="bg-gradient-to-r from-[#ff6b35] to-[#e95420] bg-clip-text text-transparent">
                  Ticketing
                </span>
              </h2>
              <p className="text-base text-[#e7e7e7] max-w-xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="group relative bg-[#1E293B] rounded-2xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300">
                ...
                <div className="relative">
                  ...
                  <h3 className="text-lg font-bold text-[#e7e7e7] mb-3">
                    Create New Ticket
                  </h3>
                  <p className="text-sm text-[#e7e7e7] mb-4 leading-relaxed">
                    Submit detailed support requests with priority levels. Our expert team responds within 24 hours.
                  </p>
                  <button
                    onClick={handleCreateTicket}
                    className="w-full py-2 px-4 text-[#e7e7e7] text-sm font-semibold rounded-lg border border-white/20 transition-all duration-200 hover:bg-[#e95420] focus:outline-none focus:ring-2 focus:ring-white/80"
      ...
      <section id="contact-form" className="py-16 md:py-24 bg-[#1A1A1A]">
        <div className="container mx-auto px-4">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="space-y-8">
                <div className="relative">
                  ...
                  <p className="text-lg text-[#e7e7e7] leading-relaxed">
                ...
                <div className="space-y-6">
                  <div className="group flex items-start space-x-4 p-4 bg-[#1E293B]/60 backdrop-blur-sm rounded-2xl border border-[#1E293B] hover:border-[#3B82F6]/30 hover:shadow-lg transition-all duration-300">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-[#e7e7e7] mb-1">Email Us</h3>
                      <p className="text-[#e7e7e7] text-base">support@Zivara.com</p>
                    </div>
                  </div>
                  ...
                  <div className="group flex items-start space-x-4 p-4 bg-[#1E293B]/60 backdrop-blur-sm rounded-2xl border border-[#1E293B] hover:border-[#3B82F6]/30 hover:shadow-lg transition-all duration-300">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-[#e7e7e7] mb-1">Response Time</h3>
                      <p className="text-[#e7e7e7] text-base">Within 24 hours</p>
                    </div>
                  </div>
          ...
          <div>
                      <h3 className="text-lg font-bold text-[#e7e7e7] mb-1">Support</h3>
                      <p className="text-[#e7e7e7] text-base">24/7 Technical Support</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative bg-[#1E293B]/80 backdrop-blur-sm rounded-3xl p-6 border border-white/10">
                  <div className="mb-8 md:mb-12">
                    ...
                    <h2 className="text-3xl font-bold text-[#e7e7e7] mb-3">
                      Send us a message
                    </h2>
                    <p className="text-[#e7e7e7] text-base">
            ...
            <label
              htmlFor="email"
                        className="block mb-2 text-base font-semibold text-[#e7e7e7]"
            >
              Your email
            </label>
            <input
          ...
          <button
            type="submit"
                      className="w-full py-4 px-6 text-lg font-bold text-center text-[#e7e7e7] rounded-2xl border border-white/20 focus:ring-4 focus:outline-none focus:ring-white/80 transition-all duration-300 hover:bg-[#e95420] disabled:opacity-50 disabled:cursor-not-allowed"
                      style={{ backgroundColor: '#ff6b35' }}
              ...
              submitStatus.includes('successfully') 
                        ...
                        <div className="flex items-center space-x-3">
                          <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                            ...
                            {submitStatus.includes('successfully') ? (
                              <svg className="w-4 h-4 text-[#e7e7e7]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
