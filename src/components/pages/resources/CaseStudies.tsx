...
const CaseStudies: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      ...
      {/* Case Studies Grid */}
      <section id="case-studies" className="py-12 sm:py-16 md:py-20 lg:py-24 bg-[#0A0A0A]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-10 md:mb-12 lg:mb-16">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#e7e7e7] mb-3 sm:mb-4">Featured Case Studies</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto">
            {/* Case Study 1 */}
            <div className="group bg-[#1A1A1A] rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-[#1E293B] overflow-hidden hover:-translate-y-2">
              <div className="h-40 sm:h-48 bg-gradient-to-br from-[#3b82f6] via-blue-600 to-indigo-600 flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-0 bg-black bg-opacity-10"></div>
                <div className="text-center text-[#e7e7e7] relative z-10">
                  <div className="w-[40px] h-[40px] bg-[#1A1A1A] bg-opacity-20 rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 backdrop-blur-sm">
                    <svg className="w-8 h-8 sm:w-10 sm:h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" />
                    </svg>
                  </div>
                  <h3 className="text-lg sm:text-xl font-bold">Financial Services</h3>
                </div>
              </div>
              <div className="p-4 sm:p-6">
                <div className="flex flex-wrap gap-2 mb-3 sm:mb-4">
                  <span className="px-2 sm:px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-xs font-medium border border-blue-200">Cloud Migration</span>
                  <span className="px-2 sm:px-3 py-1 bg-green-50 text-green-700 rounded-full text-xs font-medium border border-green-200">Security</span>
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-[#e7e7e7] mb-2 sm:mb-3 group-hover:text-[#3b82f6] transition-colors">
                  Multi-Cloud Migration for Regional Bank
                </h3>
                <p className="text-sm sm:text-base text-[#e7e7e7] mb-3 sm:mb-4 leading-relaxed">
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-4">
                  <div className="text-center p-2 sm:p-3 bg-[#1A1A1A] rounded-xl">
                    <div className="text-xl sm:text-2xl font-bold text-[#10b981]">40%</div>
                    <div className="text-xs text-[#e7e7e7]">Cost Reduction</div>
                  </div>
                  <div className="text-center p-2 sm:p-3 bg-[#1A1A1A] rounded-xl">
                    <div className="text-xl sm:text-2xl font-bold text-[#10b981]">99.9%</div>
                    <div className="text-xs text-[#e7e7e7]">Uptime</div>
                  </div>
                </div>
                <a
                  href="#"
                  className="inline-flex items-center text-[#3b82f6] hover:text-blue-700 font-semibold text-xs sm:text-sm group-hover:underline"
                >
            ...
            {/* Case Study 2 */}
            <div className="group bg-[#1A1A1A] rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-[#1E293B] overflow-hidden hover:-translate-y-2">
              <div className="h-48 bg-gradient-to-br from-green-500 via-emerald-600 to-teal-600 flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-0 bg-black bg-opacity-10"></div>
                <div className="text-center text-[#e7e7e7] relative z-10">
                  <div className="w-[40px] h-[40px] bg-[#1A1A1A] bg-opacity-20 rounded-2xl flex items-center justify-center mx-auto mb-4 backdrop-blur-sm">
            ...
            <div className="group bg-[#1A1A1A] rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-[#1E293B] overflow-hidden hover:-translate-y-2">
              ...
              <div className="p-6">
                <div className="flex flex-wrap gap-2 mb-4">
                  ...
                  <span className="px-3 py-1 bg-[#0A0A0A] text-gray-700 rounded-full text-xs font-medium border border-gray-200">Compliance</span>
                </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-[#0A0A0A]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-10 md:mb-12 lg:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#e7e7e7] mb-3 sm:mb-4">Proven Results</h2>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-[#e7e7e7] max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              <div className="w-[40px] h-[40px] bg-emerald-600 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <span className="text-xl sm:text-2xl font-bold text-[#e7e7e7]">500+</span>
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-[#e7e7e7] mb-2">Projects Completed</h3>
              <p className="text-sm sm:text-base text-[#e7e7e7]">Successfully delivered across various industries</p>
            </div>

            <div className="text-center">
              <div className="w-[40px] h-[40px] bg-[#3B82F6] rounded-full flex items-center justify-center mx-auto mb-6">
                <span className="text-2xl font-bold text-[#e7e7e7]">98%</span>
              </div>
            ...
            <div className="text-center">
              <div className="w-[40px] h-[40px] bg-[#8B5CF6] rounded-full flex items-center justify-center mx-auto mb-6">
                <span className="text-2xl font-bold text-[#e7e7e7]">50%</span>
              </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-[#0A0A0A]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-10 md:mb-12 lg:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#e7e7e7] mb-3 sm:mb-4">Industries We Serve</h2>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-[#e7e7e7] max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            <div className="text-center p-4 sm:p-6 rounded-2xl hover:bg-[#1A1A1A] transition-colors">
              <div className="w-[40px] h-[40px] bg-blue-100 rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <svg className="w-6 h-6 sm:w-8 sm:h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                </svg>
              </div>
              <h3 className="text-base sm:text-lg font-semibold text-[#e7e7e7] mb-2">Financial Services</h3>
              <p className="text-sm sm:text-base text-[#e7e7e7]">Banking, insurance, and fintech solutions</p>
            </div>

            <div className="text-center p-6 rounded-2xl hover:bg-[#0A0A0A] transition-colors">
              <div className="w-[40px] h-[40px] bg-green-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center p-6 rounded-2xl hover:bg-[#0A0A0A] transition-colors">
              <div className="w-[40px] h-[40px] bg-red-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center p-6 rounded-2xl hover:bg-[#0A0A0A] transition-colors">
              <div className="w-[40px] h-[40px] bg-purple-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center p-6 rounded-2xl hover:bg-[#0A0A0A] transition-colors">
              <div className="w-[40px] h-[40px] bg-orange-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center p-6 rounded-2xl hover:bg-[#0A0A0A] transition-colors">
              <div className="w-[40px] h-[40px] bg-indigo-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
      ...
      {/* Call to Action */}
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-r from-[#3b82f6] to-teal-600">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#e7e7e7] mb-4 sm:mb-6">
            Ready to Write Your Success Story?
          </h2>
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 mb-6 sm:mb-8 md:mb-12 max-w-3xl mx-auto">
          ...
          <a
            href="/contact"
            className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold text-[#3b82f6] bg-[#1A1A1A] rounded-full hover:bg-[#0A0A0A] transition-colors shadow-lg"
          >
