    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="case-studies" className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {/* Case Study 1 */}
            <div className="group bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 overflow-hidden hover:-translate-y-2">
      ...
      <section className="py-24 bg-gradient-to-r from-[#10b981] to-teal-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <a
            href="/contact"
            className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-[#10b981] bg-white rounded-full hover:bg-gray-50 transition-colors shadow-lg"
          >
