...
const CaseStudies: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      ...
      {/* Case Studies Grid */}
      <section id="case-studies" className="py-16 md:py-24 bg-[#1A1A1A]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12 md:mb-20">
            <h2 className="text-2xl font-bold text-[#e7e7e7] mb-4">Featured Case Studies</h2>
            ...
            <div className="group bg-[#1A1A1A] rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-[#1E293B] overflow-hidden hover:-translate-y-2">
              <div className="h-48 bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="text-center text-[#e7e7e7] relative z-10">
                  <div className="w-20 h-20 bg-[#1A1A1A] bg-opacity-20 rounded-2xl flex items-center justify-center mx-auto mb-4 backdrop-blur-sm">
