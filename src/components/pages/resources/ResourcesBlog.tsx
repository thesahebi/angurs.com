      ...
      <section className="bg-gradient-to-br from-indigo-50 to-white pt-24 pb-20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 text-[#F1F5F9]">
              Technology
              <span className="block text-indigo-600">Blog</span>
            </h1>
            <p className="text-xl md:text-2xl text-[#E2E8F0] mb-12 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="#categories"
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-indigo-600 bg-[#1E293B] border-2 border-indigo-600 rounded-full hover:bg-indigo-50 transition-colors"
              >
                Browse Categories
              </a>
            </div>
