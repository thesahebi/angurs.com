...
const ITAutomation: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#121212]">
      ...
      <section className="py-16 md:py-24 bg-[#121212]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12 md:mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-[#F1F5F9] mb-4">Why IT Automation?</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-3">24/7 Operations</h3>
              <p className="text-[#E2E8F0]">Automated systems run continuously, ensuring services are always available</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-3">Error Reduction</h3>
              <p className="text-[#E2E8F0]">Eliminate human error with consistent, repeatable automated processes</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-3">Cost Optimization</h3>
              <p className="text-[#E2E8F0]">Reduce operational costs by automating routine tasks and optimizing resource usage</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-3">Rapid Response</h3>
              <p className="text-[#E2E8F0]">Automated incident response and self-healing systems minimize downtime</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="solutions" className="py-16 md:py-24 bg-[#121212]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12 md:mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-[#F1F5F9] mb-4">IT Automation Solutions</h2>
            <p className="text-xl text-[#E2E8F0] max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="bg-[#121212] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-[#1E293B]">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Infrastructure Automation</h3>
            ...
            <div className="bg-[#121212] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-[#1E293B]">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Network Automation</h3>
              <p className="text-[#E2E8F0] leading-relaxed mb-6">
            ...
            <div className="bg-[#121212] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-[#1E293B]">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Service Desk Automation</h3>
              <p className="text-[#E2E8F0] leading-relaxed mb-6">
            ...
            <div className="bg-[#121212] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-[#1E293B]">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Backup & Recovery Automation</h3>
              <p className="text-[#E2E8F0] leading-relaxed mb-6">
            ...
            <div className="bg-[#121212] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-[#1E293B]">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Security Automation</h3>
              <p className="text-[#E2E8F0] leading-relaxed mb-6">
            ...
            <div className="bg-[#121212] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-[#1E293B]">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Cloud Operations Automation</h3>
              <p className="text-[#E2E8F0] leading-relaxed mb-6">
      ...
      <section className="py-16 md:py-24 bg-[#121212]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12 md:mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-[#F1F5F9] mb-4">Automation Tools & Platforms</h2>
            <p className="text-xl text-[#E2E8F0] max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9]">Configuration Management</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9]">Infrastructure Automation</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9]">System Management</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9]">Windows Automation</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9]">Custom Scripting</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9]">ITSM Automation</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9]">Monitoring Automation</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9]">CI/CD Automation</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-purple-600 to-indigo-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <a
            href="/contact"
            className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-purple-600 bg-[#121212] rounded-full hover:bg-[#121212] transition-colors shadow-lg"
          >
