        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">Automated systems run continuously, ensuring services are always available</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Error Reduction</h3>
              <p className="text-gray-600">Eliminate human error with consistent, repeatable automated processes</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Reduce operational costs by automating routine tasks and optimizing resource usage</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Automated incident response and self-healing systems minimize downtime</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Service Desk Automation</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Backup & Recovery Automation</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Cloud Operations Automation</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Infrastructure Automation</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Windows Automation</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Custom Scripting</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900">ITSM Automation</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Monitoring Automation</h3>
            </div>
