    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">10x Faster Deployments</h3>
              <p className="text-gray-600">Reduce deployment time from hours to minutes with automated CI/CD pipelines</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">99.9% Reliability</h3>
              <p className="text-gray-600">Automated testing and quality gates ensure consistent, reliable releases</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">50% Cost Reduction</h3>
              <p className="text-gray-600">Eliminate manual processes and reduce operational overhead significantly</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Break down silos and foster collaboration between development and operations</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">CI/CD Pipeline Setup</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Configuration Management</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Security Integration</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">Analyze current processes, identify bottlenecks, and define automation goals</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Create comprehensive DevOps architecture and automation strategy</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Build and deploy CI/CD pipelines, infrastructure, and monitoring systems</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Continuous improvement, training, and scaling of DevOps practices</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <a
            href="/contact"
            className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-blue-600 bg-white rounded-full hover:bg-gray-50 transition-colors shadow-lg"
          >
