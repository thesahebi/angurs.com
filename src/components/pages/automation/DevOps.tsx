    ...
    <div className="min-h-screen bg-[#121212]">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-3">10x Faster Deployments</h3>
              <p className="text-[#E2E8F0]">Reduce deployment time from hours to minutes with automated CI/CD pipelines</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-3">99.9% Reliability</h3>
              <p className="text-[#E2E8F0]">Automated testing and quality gates ensure consistent, reliable releases</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-3">50% Cost Reduction</h3>
              <p className="text-[#E2E8F0]">Eliminate manual processes and reduce operational overhead significantly</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-3">Team Collaboration</h3>
              <p className="text-[#E2E8F0]">Break down silos and foster collaboration between development and operations</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="bg-[#1E293B] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-[#1E293B]">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">CI/CD Pipeline Setup</h3>
            ...
            <div className="bg-[#1E293B] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-[#1E293B]">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Infrastructure as Code</h3>
              <p className="text-[#E2E8F0] leading-relaxed mb-6">
            ...
            <div className="bg-[#1E293B] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-[#1E293B]">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Container Orchestration</h3>
              <p className="text-[#E2E8F0] leading-relaxed mb-6">
            ...
            <div className="bg-[#1E293B] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-[#1E293B]">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Configuration Management</h3>
              <p className="text-[#E2E8F0] leading-relaxed mb-6">
            ...
            <div className="bg-[#1E293B] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-[#1E293B]">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Monitoring & Observability</h3>
              <p className="text-[#E2E8F0] leading-relaxed mb-6">
            ...
            <div className="bg-[#1E293B] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-[#1E293B]">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Security Integration</h3>
              <p className="text-[#E2E8F0] leading-relaxed mb-6">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9] mb-2">Assessment</h3>
              <p className="text-[#E2E8F0]">Analyze current processes, identify bottlenecks, and define automation goals</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9] mb-2">Design</h3>
              <p className="text-[#E2E8F0]">Create comprehensive DevOps architecture and automation strategy</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9] mb-2">Implementation</h3>
              <p className="text-[#E2E8F0]">Build and deploy CI/CD pipelines, infrastructure, and monitoring systems</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9] mb-2">Optimization</h3>
              <p className="text-[#E2E8F0]">Continuous improvement, training, and scaling of DevOps practices</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <a
            href="/contact"
            className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-blue-600 bg-[#1E293B] rounded-full hover:bg-[#121212] transition-colors shadow-lg"
          >
