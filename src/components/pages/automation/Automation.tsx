        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-3">Speed & Efficiency</h3>
              <p className="text-[#E2E8F0]">Reduce deployment times from hours to minutes with automated workflows</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-3">Consistency & Quality</h3>
              <p className="text-[#E2E8F0]">Eliminate human error and ensure consistent, reliable deployments</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-3">Cost Reduction</h3>
              <p className="text-[#E2E8F0]">Lower operational costs by reducing manual effort and resource requirements</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#F1F5F9] mb-3">Scalability</h3>
              <p className="text-[#E2E8F0]">Scale operations seamlessly without proportional increases in team size</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="bg-[#1E293B] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">DevOps Automation</h3>
            ...
            <div className="bg-[#1E293B] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Data & Analytics Automation</h3>
              <p className="text-[#E2E8F0] leading-relaxed mb-6">
            ...
            <div className="bg-[#1E293B] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-[#F1F5F9] mb-4">Business Process Automation</h3>
              <p className="text-[#E2E8F0] leading-relaxed mb-6">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9]">Infrastructure as Code</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9]">Containerization</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9]">Orchestration</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9]">DevOps Platform</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9]">Scripting & Automation</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#F1F5F9]">Monitoring</h3>
            </div>
          </div>
        </div>
      </section>
