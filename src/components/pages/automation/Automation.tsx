  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-12 leading-relaxed">
              Transform your operations with cutting-edge automation solutions. From DevOps 
              pipelines to IT infrastructure management, we automate the complex to accelerate your success.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Why Automation Matters</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">Reduce deployment times from hours to minutes with automated workflows</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Eliminate human error and ensure consistent, reliable deployments</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Lower operational costs by reducing manual effort and resource requirements</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Scale operations seamlessly without proportional increases in team size</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="solutions" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Our Automation Solutions</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">DevOps Automation</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Data & Analytics Automation</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Automation Technologies</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900">CI/CD Automation</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900">DevOps Platform</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Scripting & Automation</h3>
            </div>
